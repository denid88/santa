...
final darkTheme = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    displayLarge:
        AppTextStyles.displayLarge.copyWith(color: AppColors.baseWhite),
    displayMedium:
        AppTextStyles.displayMedium.copyWith(color: AppColors.baseWhite),
    displaySmall:
        AppTextStyles.displaySmall.copyWith(color: AppColors.baseWhite),
